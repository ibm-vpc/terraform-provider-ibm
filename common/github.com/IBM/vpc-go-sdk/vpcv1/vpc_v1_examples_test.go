...
var _ = Describe(`VpcV1 Examples Tests`, func() {
	...
	Describe(`VpcV1 request examples`, func() {
		...
		It(`AddSecurityGroupTarget request example`, func() {
			...
			securityGroupTargetReferenceIntf, response, err := vpcService.AddSecurityGroupTarget(options)
		...
		It(`RemoveSecurityGroupTarget request example`, func() {
