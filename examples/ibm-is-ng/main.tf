...
data "ibm_is_cluster_network" "is_cluster_network_instance" {
  is_cluster_network_id = var.data_is_cluster_network_is_cluster_network_id
}
*/
...
data "ibm_is_cluster_network_interface" "is_cluster_network_interface_instance" {
  ...
  is_cluster_network_interface_id = var.data_is_cluster_network_interface_is_cluster_network_interface_id
}
*/
...
data "ibm_is_cluster_network_subnet" "is_cluster_network_subnet_instance" {
  ...
  is_cluster_network_subnet_id = var.is_cluster_network_subnet_is_cluster_network_subnet_id
}
*/
...
data "ibm_is_cluster_network_subnet_reserved_ip" "is_cluster_network_subnet_reserved_ip_instance" {
  ...
  is_cluster_network_subnet_reserved_ip_id = var.is_cluster_network_subnet_reserved_ip_is_cluster_network_subnet_reserved_ip_id
}
*/
