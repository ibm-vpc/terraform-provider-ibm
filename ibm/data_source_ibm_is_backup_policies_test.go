		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// resource.TestCheckResourceAttrSet("data.ibm_is_backup_policies.is_backup_policies", "first.#"),
					// resource.TestCheckResourceAttrSet("data.ibm_is_backup_policies.is_backup_policies", "limit"),
