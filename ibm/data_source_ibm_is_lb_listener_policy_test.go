		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_lb_listener_policy.is_lb_listener_policy", "load_balancer_id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_lb_listener_policy.is_lb_listener_policy", "listener_id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_lb_listener_policy.is_lb_listener_policy", "id"),
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_lb_listener_policy.is_lb_listener_policy", "rules.#"),
				),
			},
		},
	})
