		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resName, "profiles.0.reservation_terms.#"),
					resource.TestCheckResourceAttrSet(resName, "profiles.0.reservation_terms.0.type"),
					resource.TestCheckResourceAttrSet(resName, "profiles.0.reservation_terms.0.values"),
				),
			},
		},
	})
