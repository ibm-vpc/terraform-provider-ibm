...
func TestDataSourceIBMIsClusterNetworkInterfaceClusterNetworkSubnetReservedIPReferenceDeletedToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsClusterNetworkInterfaceClusterNetworkSubnetReservedIPReferenceDeletedToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
...
func TestDataSourceIBMIsClusterNetworkInterfaceClusterNetworkSubnetReferenceDeletedToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsClusterNetworkInterfaceClusterNetworkSubnetReferenceDeletedToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
...
func TestDataSourceIBMIsClusterNetworkInterfaceClusterNetworkInterfaceTargetInstanceClusterNetworkAttachmentReferenceToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["href"] = "https://us-south.iaas.cloud.ibm.com/v1/instances/5dd61d72-acaa-47c2-a336-3d849660d010/cluster_network_attachments/0767-fb880975-db45-4459-8548-64e3995ac213"
		model["id"] = "0767-fb880975-db45-4459-8548-64e3995ac213"
	...
	result, err := vpc.DataSourceIBMIsClusterNetworkInterfaceClusterNetworkInterfaceTargetInstanceClusterNetworkAttachmentReferenceToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
...
func TestDataSourceIBMIsClusterNetworkInterfaceVPCReferenceDeletedToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsClusterNetworkInterfaceVPCReferenceDeletedToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
