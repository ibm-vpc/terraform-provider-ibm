...
func TestDataSourceIBMIsClusterNetworkProfilesClusterNetworkProfileToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		...
		zoneReferenceModel["href"] = "https://us-south.iaas.cloud.ibm.com/v1/regions/us-south/zones/us-south-2"
		zoneReferenceModel["name"] = "us-south-2"
	...
	zoneReferenceModel.Href = core.StringPtr("https://us-south.iaas.cloud.ibm.com/v1/regions/us-south/zones/us-south-2")
	zoneReferenceModel.Name = core.StringPtr("us-south-2")
