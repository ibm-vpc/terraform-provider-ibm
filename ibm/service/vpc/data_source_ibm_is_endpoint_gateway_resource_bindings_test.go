...
func TestAccIBMIsEndpointGatewayResourceBindingsDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMIsEndpointGatewayResourceBindingsDataSourceConfigBasic(endpointGatewayResourceBindingEndpointGatewayID),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "endpoint_gateway_id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.#"),
				),
			},
		},
	})
...
func TestAccIBMIsEndpointGatewayResourceBindingsDataSourceAllArgs(t *testing.T) {
	endpointGatewayResourceBindingEndpointGatewayID := fmt.Sprintf("tf_endpoint_gateway_id_%d", acctest.RandIntRange(10, 100))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMIsEndpointGatewayResourceBindingsDataSourceConfig(endpointGatewayResourceBindingEndpointGatewayID, endpointGatewayResourceBindingName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "endpoint_gateway_id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.0.created_at"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.0.href"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.0.id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.0.lifecycle_state"),
					resource.TestCheckResourceAttr("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.0.name", endpointGatewayResourceBindingName),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.0.resource_type"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.0.service_endpoint"),
					resource.TestCheckResourceAttrSet("data.ibm_is_endpoint_gateway_resource_bindings.is_endpoint_gateway_resource_bindings_instance", "resource_bindings.0.type"),
				),
			},
		},
	})
...
func testAccCheckIBMIsEndpointGatewayResourceBindingsDataSourceConfigBasic(endpointGatewayResourceBindingEndpointGatewayID string) string {
	return fmt.Sprintf(`
		...
		data "ibm_is_endpoint_gateway_resource_bindings" "is_endpoint_gateway_resource_bindings_instance" {
...
func testAccCheckIBMIsEndpointGatewayResourceBindingsDataSourceConfig(endpointGatewayResourceBindingEndpointGatewayID string, endpointGatewayResourceBindingName string) string {
	return fmt.Sprintf(`
		resource "ibm_is_endpoint_gateway_resource_binding" "is_endpoint_gateway_resource_binding_instance" {
			endpoint_gateway_id = "%s"
			name = "%s"
...
func TestDataSourceIBMIsEndpointGatewayResourceBindingsEndpointGatewayResourceBindingToMap(t *testing.T) {
	...
	result, err := vpc.DataSourceIBMIsEndpointGatewayResourceBindingsEndpointGatewayResourceBindingToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsEndpointGatewayResourceBindingsEndpointGatewayResourceBindingLifecycleReasonToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsEndpointGatewayResourceBindingsEndpointGatewayResourceBindingLifecycleReasonToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsEndpointGatewayResourceBindingsEndpointGatewayResourceBindingTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsEndpointGatewayResourceBindingsEndpointGatewayResourceBindingTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsEndpointGatewayResourceBindingsEndpointGatewayResourceBindingTargetCRNToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["crn"] = "crn:v1:bluemix:public:cloud-object-storage:global:a/aa2432b1fa4d4ace891e9b80fc104e34:1a0ec336-f391-4091-a6fb-5e084a4c56f4:bucket:bucket-27200-lwx4cfvcue"
	...
	result, err := vpc.DataSourceIBMIsEndpointGatewayResourceBindingsEndpointGatewayResourceBindingTargetCRNToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
