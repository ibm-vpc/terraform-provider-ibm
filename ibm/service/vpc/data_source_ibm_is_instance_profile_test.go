		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_instance_profile.test1", "vcpu_tenancy.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_instance_profile.test1", "vcpu_tenancy.0.type"),
					resource.TestCheckResourceAttrSet("data.ibm_is_instance_profile.test1", "vcpu_tenancy.0.values.#"),
				),
			},
		},
	})
