...
func TestAccIBMISInstanceNICReservedIP_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccIBMISInstanceNICReservedIPdataSoruceConfig(vpcName, subnetName, resIPName),
...
func testAccIBMISInstanceNICReservedIPdataSoruceConfig(vpcName, subnetName, reservedIPName string) string {
	return fmt.Sprintf(`
