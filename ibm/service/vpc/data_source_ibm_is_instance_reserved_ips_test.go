...
func TestAccIBMISInstanceNICReservedIPs_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccIBMISInstanceNICReservedIPSResoruceConfig2(vpcName, subnetName,
...
func testAccIBMISInstanceNICReservedIPSResoruceConfig2(vpcName, subnetName, reservedIPName, reservedIPName2 string) string {
	return fmt.Sprintf(`
