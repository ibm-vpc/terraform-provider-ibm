		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.ibm_is_public_address_ranges.is_public_address_ranges_instance", "public_address_ranges.0.ipv4_address_count", ipv4AddressCount),
				),
			},
		},
	})
