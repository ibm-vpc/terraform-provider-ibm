...
func TestAccIBMIsVirtualEndpointGatewayResourceBindingDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMIsVirtualEndpointGatewayResourceBindingDataSourceConfigBasic(endpointGatewayResourceBindingEndpointGatewayID),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "lifecycle_state"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "name"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "resource_type"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "service_endpoint"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "target.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "type"),
				),
			},
		},
	})
...
func TestAccIBMIsVirtualEndpointGatewayResourceBindingDataSourceAllArgs(t *testing.T) {
	endpointGatewayResourceBindingEndpointGatewayID := fmt.Sprintf("tf_endpoint_gateway_id_%d", acctest.RandIntRange(10, 100))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMIsVirtualEndpointGatewayResourceBindingDataSourceConfig(endpointGatewayResourceBindingEndpointGatewayID, endpointGatewayResourceBindingName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "endpoint_gateway_id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "endpoint_gateway_resource_binding_id"),
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "href"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "lifecycle_reasons.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "lifecycle_reasons.0.code"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "lifecycle_reasons.0.message"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "lifecycle_reasons.0.more_info"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "lifecycle_state"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "name"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "resource_type"),
					resource.TestCheckResourceAttrSet("data.ibm_is_virtual_endpoint_gateway_resource_binding.is_virtual_endpoint_gateway_resource_binding_instance", "service_endpoint"),
...
func testAccCheckIBMIsVirtualEndpointGatewayResourceBindingDataSourceConfigBasic(endpointGatewayResourceBindingEndpointGatewayID string) string {
	return fmt.Sprintf(`
...
func testAccCheckIBMIsVirtualEndpointGatewayResourceBindingDataSourceConfig(endpointGatewayResourceBindingEndpointGatewayID string, endpointGatewayResourceBindingName string) string {
	return fmt.Sprintf(`
		resource "ibm_is_virtual_endpoint_gateway_resource_binding" "is_virtual_endpoint_gateway_resource_binding_instance" {
			endpoint_gateway_id = "%s"
			name = "%s"
...
func TestDataSourceIBMIsVirtualEndpointGatewayResourceBindingEndpointGatewayResourceBindingLifecycleReasonToMap(t *testing.T) {
	...
	result, err := vpc.DataSourceIBMIsVirtualEndpointGatewayResourceBindingEndpointGatewayResourceBindingLifecycleReasonToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsVirtualEndpointGatewayResourceBindingEndpointGatewayResourceBindingTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsVirtualEndpointGatewayResourceBindingEndpointGatewayResourceBindingTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsVirtualEndpointGatewayResourceBindingEndpointGatewayResourceBindingTargetCRNToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["crn"] = "crn:v1:bluemix:public:cloud-object-storage:global:a/aa2432b1fa4d4ace891e9b80fc104e34:1a0ec336-f391-4091-a6fb-5e084a4c56f4:bucket:bucket-27200-lwx4cfvcue"
	...
	result, err := vpc.DataSourceIBMIsVirtualEndpointGatewayResourceBindingEndpointGatewayResourceBindingTargetCRNToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
