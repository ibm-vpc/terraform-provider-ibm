		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_vpc.ds_vpc", "public_address_ranges.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_vpc.ds_vpc_by_id", "public_address_ranges.#"),
				),
			},
		},
	})
