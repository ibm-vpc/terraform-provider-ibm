...
func TestResourceIBMIsClusterNetworkInterfaceClusterNetworkSubnetReservedIPReferenceDeletedToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.ResourceIBMIsClusterNetworkInterfaceClusterNetworkSubnetReservedIPReferenceDeletedToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
...
func TestResourceIBMIsClusterNetworkInterfaceClusterNetworkSubnetReferenceDeletedToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.ResourceIBMIsClusterNetworkInterfaceClusterNetworkSubnetReferenceDeletedToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
...
func TestResourceIBMIsClusterNetworkInterfaceClusterNetworkInterfaceTargetInstanceClusterNetworkAttachmentReferenceToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["href"] = "https://us-south.iaas.cloud.ibm.com/v1/instances/5dd61d72-acaa-47c2-a336-3d849660d010/cluster_network_attachments/0767-fb880975-db45-4459-8548-64e3995ac213"
		model["id"] = "0767-fb880975-db45-4459-8548-64e3995ac213"
	...
	result, err := vpc.ResourceIBMIsClusterNetworkInterfaceClusterNetworkInterfaceTargetInstanceClusterNetworkAttachmentReferenceToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
...
func TestResourceIBMIsClusterNetworkInterfaceVPCReferenceDeletedToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.ResourceIBMIsClusterNetworkInterfaceVPCReferenceDeletedToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
