			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr(
						"ibm_is_image.isExampleImage", "obsolescence_at"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"ibm_is_image.isExampleImage", "name", name),
					resource.TestCheckNoResourceAttr(
						"ibm_is_image.isExampleImage", "deprecation_at"),
					resource.TestCheckNoResourceAttr(
						"ibm_is_image.isExampleImage", "obsolescence_at"),
				),
			},
...
func testAccCheckIBMISImageLifecycleObsoleteConfig(name string, obsolete bool) string {
	return fmt.Sprintf(`
		resource "ibm_is_image" "isExampleImage" {
			href = "%s"
			name = "%s"
	...
	`, acc.Image_cos_url, name, acc.Image_operating_system, obsolete)
}
