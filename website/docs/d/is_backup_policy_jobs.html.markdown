...
Provides a read-only data source for BackupPolicyJobCollection. For more information, about backup policy in your IBM Cloud VPC, see [Backup policy](https://cloud.ibm.com/docs/vpc?topic=vpc-backups-vpc-best-practices&interface=ui).
