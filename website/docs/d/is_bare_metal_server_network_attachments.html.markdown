...
description: |-
  Lists information about is_bare_metal_server_network_attachments
subcategory: "Virtual Private Cloud API"
---

# ibm_is_bare_metal_server_network_attachment

Provides a read-only data source collection to retrieve information about an is_bare_metal_server_network_attachments. You can then reference the fields of the data source in other resources within the same configuration by using interpolation syntax.
