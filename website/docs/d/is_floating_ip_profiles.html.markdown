---
layout: "ibm"
page_title: "IBM : ibm_is_floating_ip_profiles"
description: |-
  Get information about FloatingIPProfileCollection
subcategory: "Virtual Private Cloud API"
---

# ibm_is_floating_ip_profiles

Provides a read-only data source to retrieve information about a FloatingIPProfileCollection. You can then reference the fields of the data source in other resources within the same configuration by using interpolation syntax.

## Example Usage

```hcl
data "ibm_is_floating_ip_profiles" "is_floating_ip_profiles" {
}
```
...
* `id` - The unique identifier of the FloatingIPProfileCollection.
* `profiles` - (List) A page of floating IP profiles.
